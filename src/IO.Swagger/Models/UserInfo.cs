...
namespace IO.Swagger.Models
{
    ...
    public partial class UserInfo :  IEquatable<UserInfo>
    {
        ...
        public UserInfo(string DbUsername = null, string Password = null, List<string> Grant = null)
        {
            // to ensure "DbUsername" is required (not null)
            if (DbUsername == null)
            {
                throw new InvalidDataException("DbUsername is a required property for UserInfo and cannot be null");
            }
            else
            {
