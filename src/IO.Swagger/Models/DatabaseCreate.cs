...
namespace IO.Swagger.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class DatabaseCreate :  IEquatable<DatabaseCreate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DatabaseCreate" /> class.
        /// </summary>
        ...
        public DatabaseCreate(string DatabaseName = null, string DbUser = null, string DatabaseType = null, long? DbSize = null)
        {
            // to ensure "DatabaseName" is required (not null)
            if (DatabaseName == null)
            {
                throw new InvalidDataException("DatabaseName is a required property for DatabaseCreate and cannot be null");
            }
            else
            {
            ...
            if (DbUser == null)
            {
                throw new InvalidDataException("DbUser is a required property for DatabaseCreate and cannot be null");
            }
            else
            {
                this.DbUser = DbUser;
            ...
            {
                throw new InvalidDataException("DatabaseType is a required property for DatabaseCreate and cannot be null");
            }
            else
            {
            ...
            if (DbSize == null)
            {
                throw new InvalidDataException("DbSize is a required property for DatabaseCreate and cannot be null");
            }
            else
            {
                this.DbSize = DbSize;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DatabaseCreate {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals((DatabaseCreate)obj);
        }

        /// <summary>
        /// Returns true if DatabaseCreate instances are equal
        /// </summary>
        /// <param name="other">Instance of DatabaseCreate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DatabaseCreate other)
        {
        ...
        public static bool operator ==(DatabaseCreate left, DatabaseCreate right)
        {
