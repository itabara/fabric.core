...
namespace IO.Swagger.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class SecurityRuleUpdate :  IEquatable<SecurityRuleUpdate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SecurityRuleUpdate" /> class.
        /// </summary>
        /// <param name="IpSource">source ip of the request.</param>
        /// <param name="AccessType">Allow or Deny.</param>
        public SecurityRuleUpdate(string IpSource = null, string AccessType = null)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SecurityRuleUpdate {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals((SecurityRuleUpdate)obj);
        }

        /// <summary>
        /// Returns true if SecurityRuleUpdate instances are equal
        /// </summary>
        /// <param name="other">Instance of SecurityRuleUpdate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SecurityRuleUpdate other)
        {
        ...
        public static bool operator ==(SecurityRuleUpdate left, SecurityRuleUpdate right)
        {
