...
namespace IO.Swagger.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class HostingAccountRequest :  IEquatable<HostingAccountRequest>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HostingAccountRequest" /> class.
        /// </summary>
        ...
        public HostingAccountRequest(string HostingName = null, string HostingAdminEmail = null, long? DiskQuota = null, int? FtpQuota = null, long? BandwidthQuota = null, int? DbQuota = null, long? DbMaxSize = null, string Region = null)
        {
            // to ensure "HostingName" is required (not null)
            if (HostingName == null)
            {
                throw new InvalidDataException("HostingName is a required property for HostingAccountRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("HostingAdminEmail is a required property for HostingAccountRequest and cannot be null");
            }
            else
            {
            ...
            if (DiskQuota == null)
            {
                throw new InvalidDataException("DiskQuota is a required property for HostingAccountRequest and cannot be null");
            }
            else
            {
            ...
            if (FtpQuota == null)
            {
                throw new InvalidDataException("FtpQuota is a required property for HostingAccountRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("BandwidthQuota is a required property for HostingAccountRequest and cannot be null");
            }
            else
            {
            ...
            if (DbQuota == null)
            {
                throw new InvalidDataException("DbQuota is a required property for HostingAccountRequest and cannot be null");
            }
            else
            {
            ...
            if (DbMaxSize == null)
            {
                throw new InvalidDataException("DbMaxSize is a required property for HostingAccountRequest and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class HostingAccountRequest {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals((HostingAccountRequest)obj);
        }

        /// <summary>
        /// Returns true if HostingAccountRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of HostingAccountRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HostingAccountRequest other)
        {
        ...
        public static bool operator ==(HostingAccountRequest left, HostingAccountRequest right)
        {
