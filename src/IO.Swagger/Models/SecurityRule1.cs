...
namespace IO.Swagger.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class SecurityRule1 :  IEquatable<SecurityRule1>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SecurityRule1" /> class.
        /// </summary>
        /// <param name="IpSource">source ip of the request.</param>
        /// <param name="AccessType">Allow or Deny.</param>
        public SecurityRule1(string IpSource = null, string AccessType = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals((SecurityRule1)obj);
        }

        /// <summary>
        /// Returns true if SecurityRule1 instances are equal
        /// </summary>
        /// <param name="other">Instance of SecurityRule1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SecurityRule1 other)
        {
        ...
        public static bool operator ==(SecurityRule1 left, SecurityRule1 right)
        {
