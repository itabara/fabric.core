...
namespace IO.Swagger.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class HostingAccountCreate :  IEquatable<HostingAccountCreate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HostingAccountCreate" /> class.
        /// </summary>
        ...
        public HostingAccountCreate(string HostingName = null, string HostingAdminEmail = null, long? DiskQuota = null, int? FtpQuota = null, long? BandwidthQuota = null, int? DbQuota = null, long? DbMaxSize = null, string Region = null)
        {
            // to ensure "HostingName" is required (not null)
            if (HostingName == null)
            {
                throw new InvalidDataException("HostingName is a required property for HostingAccountCreate and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("HostingAdminEmail is a required property for HostingAccountCreate and cannot be null");
            }
            else
            {
            ...
            if (DiskQuota == null)
            {
                throw new InvalidDataException("DiskQuota is a required property for HostingAccountCreate and cannot be null");
            }
            else
            {
            ...
            if (FtpQuota == null)
            {
                throw new InvalidDataException("FtpQuota is a required property for HostingAccountCreate and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("BandwidthQuota is a required property for HostingAccountCreate and cannot be null");
            }
            else
            {
            ...
            if (DbQuota == null)
            {
                throw new InvalidDataException("DbQuota is a required property for HostingAccountCreate and cannot be null");
            }
            else
            {
            ...
            if (DbMaxSize == null)
            {
                throw new InvalidDataException("DbMaxSize is a required property for HostingAccountCreate and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class HostingAccountCreate {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals((HostingAccountCreate)obj);
        }

        /// <summary>
        /// Returns true if HostingAccountCreate instances are equal
        /// </summary>
        /// <param name="other">Instance of HostingAccountCreate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HostingAccountCreate other)
        {
        ...
        public static bool operator ==(HostingAccountCreate left, HostingAccountCreate right)
        {
